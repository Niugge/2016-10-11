...
uint8_t  TX_ADDRESS[TX_ADR_WIDTH]= {0xAA,0xBB,0xCC,0x00,0x09};	//本地地址
uint8_t  RX_ADDRESS[RX_ADR_WIDTH]= {0xAA,0xBB,0xCC,0x00,0x09};	//接收地址
...
{	
	...
	NRF_Write_Buf(WR_TX_PLOAD2, tx_buf, len); // 装载数据	
